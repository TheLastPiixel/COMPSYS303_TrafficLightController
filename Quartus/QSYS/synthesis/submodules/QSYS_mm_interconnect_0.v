...
module QSYS_mm_interconnect_0 (
	...
	wire  [102:0] cmd_mux_006_src_data;                                                      // cmd_mux_006:src_data -> timer_1_s1_agent:cp_data
	wire          cmd_mux_006_src_ready;                                                     // timer_1_s1_agent:cp_ready -> cmd_mux_006:src_ready
	wire   [11:0] cmd_mux_006_src_channel;                                                   // cmd_mux_006:src_channel -> timer_1_s1_agent:cp_channel
	...
	wire  [102:0] cmd_mux_007_src_data;                                                      // cmd_mux_007:src_data -> timer_0_s1_agent:cp_data
	...
	wire  [102:0] cmd_mux_009_src_data;                                                      // cmd_mux_009:src_data -> keys_s1_agent:cp_data
	wire          cmd_mux_009_src_ready;                                                     // keys_s1_agent:cp_ready -> cmd_mux_009:src_ready
	wire   [11:0] cmd_mux_009_src_channel;                                                   // cmd_mux_009:src_channel -> keys_s1_agent:cp_channel
	...
	wire          cmd_mux_011_src_valid;                                                     // cmd_mux_011:src_valid -> leds_red_s1_agent:cp_valid
	wire  [102:0] cmd_mux_011_src_data;                                                      // cmd_mux_011:src_data -> leds_red_s1_agent:cp_data
	wire          cmd_mux_011_src_ready;                                                     // leds_red_s1_agent:cp_ready -> cmd_mux_011:src_ready
	wire   [11:0] cmd_mux_011_src_channel;                                                   // cmd_mux_011:src_channel -> leds_red_s1_agent:cp_channel
	wire          cmd_mux_011_src_startofpacket;                                             // cmd_mux_011:src_startofpacket -> leds_red_s1_agent:cp_startofpacket
	wire          cmd_mux_011_src_endofpacket;                                               // cmd_mux_011:src_endofpacket -> leds_red_s1_agent:cp_endofpacket
	...
	wire   [84:0] onchip_mem_s1_agent_rp_data;                                               // onchip_mem_s1_agent:rp_data -> router_006:sink_data
	...
	wire  [102:0] timer_1_s1_agent_rp_data;                                                  // timer_1_s1_agent:rp_data -> router_008:sink_data
	...
	wire  [102:0] timer_0_s1_agent_rp_data;                                                  // timer_0_s1_agent:rp_data -> router_009:sink_data
	...
	wire  [102:0] keys_s1_agent_rp_data;                                                     // keys_s1_agent:rp_data -> router_011:sink_data
	...
	wire          leds_red_s1_agent_rp_valid;                                                // leds_red_s1_agent:rp_valid -> router_013:sink_valid
	wire  [102:0] leds_red_s1_agent_rp_data;                                                 // leds_red_s1_agent:rp_data -> router_013:sink_data
	wire          leds_red_s1_agent_rp_ready;                                                // router_013:sink_ready -> leds_red_s1_agent:rp_ready
	wire          leds_red_s1_agent_rp_startofpacket;                                        // leds_red_s1_agent:rp_startofpacket -> router_013:sink_startofpacket
	wire          leds_red_s1_agent_rp_endofpacket;                                          // leds_red_s1_agent:rp_endofpacket -> router_013:sink_endofpacket
	...
	wire   [11:0] router_005_src_channel;                                                    // router_005:src_channel -> sdram_s1_rsp_width_adapter:in_channel
	...
	wire   [11:0] sdram_s1_rsp_width_adapter_src_channel;                                    // sdram_s1_rsp_width_adapter:out_channel -> rsp_demux_003:sink_channel
	...
	wire          router_006_src_valid;                                                      // router_006:src_valid -> onchip_mem_s1_rsp_width_adapter:in_valid
	wire   [84:0] router_006_src_data;                                                       // router_006:src_data -> onchip_mem_s1_rsp_width_adapter:in_data
	wire          router_006_src_ready;                                                      // onchip_mem_s1_rsp_width_adapter:in_ready -> router_006:src_ready
	wire   [11:0] router_006_src_channel;                                                    // router_006:src_channel -> onchip_mem_s1_rsp_width_adapter:in_channel
	wire          router_006_src_startofpacket;                                              // router_006:src_startofpacket -> onchip_mem_s1_rsp_width_adapter:in_startofpacket
	wire          router_006_src_endofpacket;                                                // router_006:src_endofpacket -> onchip_mem_s1_rsp_width_adapter:in_endofpacket
	wire          onchip_mem_s1_rsp_width_adapter_src_valid;                                 // onchip_mem_s1_rsp_width_adapter:out_valid -> rsp_demux_004:sink_valid
	wire  [102:0] onchip_mem_s1_rsp_width_adapter_src_data;                                  // onchip_mem_s1_rsp_width_adapter:out_data -> rsp_demux_004:sink_data
	wire          onchip_mem_s1_rsp_width_adapter_src_ready;                                 // rsp_demux_004:sink_ready -> onchip_mem_s1_rsp_width_adapter:out_ready
	wire   [11:0] onchip_mem_s1_rsp_width_adapter_src_channel;                               // onchip_mem_s1_rsp_width_adapter:out_channel -> rsp_demux_004:sink_channel
	wire          onchip_mem_s1_rsp_width_adapter_src_startofpacket;                         // onchip_mem_s1_rsp_width_adapter:out_startofpacket -> rsp_demux_004:sink_startofpacket
	wire          onchip_mem_s1_rsp_width_adapter_src_endofpacket;                           // onchip_mem_s1_rsp_width_adapter:out_endofpacket -> rsp_demux_004:sink_endofpacket
	...
	wire   [11:0] cmd_mux_003_src_channel;                                                   // cmd_mux_003:src_channel -> sdram_s1_cmd_width_adapter:in_channel
	...
	wire          cmd_mux_004_src_valid;                                                     // cmd_mux_004:src_valid -> onchip_mem_s1_cmd_width_adapter:in_valid
	wire  [102:0] cmd_mux_004_src_data;                                                      // cmd_mux_004:src_data -> onchip_mem_s1_cmd_width_adapter:in_data
	wire          cmd_mux_004_src_ready;                                                     // onchip_mem_s1_cmd_width_adapter:in_ready -> cmd_mux_004:src_ready
	wire   [11:0] cmd_mux_004_src_channel;                                                   // cmd_mux_004:src_channel -> onchip_mem_s1_cmd_width_adapter:in_channel
	wire          cmd_mux_004_src_startofpacket;                                             // cmd_mux_004:src_startofpacket -> onchip_mem_s1_cmd_width_adapter:in_startofpacket
	wire          cmd_mux_004_src_endofpacket;                                               // cmd_mux_004:src_endofpacket -> onchip_mem_s1_cmd_width_adapter:in_endofpacket
	...
	wire   [17:0] onchip_mem_s1_agent_rdata_fifo_src_data;                                   // onchip_mem_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_004:in_0_data
	...
	wire   [17:0] avalon_st_adapter_004_out_0_data;                                          // avalon_st_adapter_004:out_0_data -> onchip_mem_s1_agent:rdata_fifo_sink_data
	...
	wire          leds_red_s1_agent_rdata_fifo_src_valid;                                    // leds_red_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_011:in_0_valid
	wire   [33:0] leds_red_s1_agent_rdata_fifo_src_data;                                     // leds_red_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_011:in_0_data
	wire          leds_red_s1_agent_rdata_fifo_src_ready;                                    // avalon_st_adapter_011:in_0_ready -> leds_red_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_011_out_0_valid;                                         // avalon_st_adapter_011:out_0_valid -> leds_red_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_011_out_0_data;                                          // avalon_st_adapter_011:out_0_data -> leds_red_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_011_out_0_ready;                                         // leds_red_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_011:out_0_ready
	wire    [0:0] avalon_st_adapter_011_out_0_error;                                         // avalon_st_adapter_011:out_0_error -> leds_red_s1_agent:rdata_fifo_sink_error
	...
	QSYS_mm_interconnect_0_router_005 router_006 (
	...
	QSYS_mm_interconnect_0_cmd_mux_002 cmd_mux_004 (
		.clk                 (sdram_pll_sys_clk_clk),                 //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	QSYS_mm_interconnect_0_rsp_demux_002 rsp_demux_004 (
		.clk                (sdram_pll_sys_clk_clk),                             //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset),             // clk_reset.reset
